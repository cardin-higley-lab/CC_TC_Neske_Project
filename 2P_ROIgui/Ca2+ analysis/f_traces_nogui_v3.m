function ROI_list = f_traces_nogui_v3(im,ROI_list,frame_rate,output_filename,output_pathname)
...
max_im=max(im,[],3);
min_im=min(im,[],3);
DispRange=[prctile(min_im(:),0.0),prctile(max_im(:),98)];
...
%deconvolution.
%dFF_filter = 'exponential'; %[];
dFF_filter = 'no filter';
tau_0 = 0.2;
tau_1 = .75;
%tau_2 = 3;
tau_2 = 20;
